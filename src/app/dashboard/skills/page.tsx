  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight text-white">Skill Paths</h1>
        <Link 
          ...
          <table className="w-full text-left text-sm text-zinc-300">
            ...
            <tbody className="divide-y divide-zinc-800/50">
              {!skills?.length ? (
                ...
                skills.map((skill) => (
                  <tr key={skill.id} className="hover:bg-zinc-800/30 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div 
                          className="w-3 h-3 rounded-full shadow-lg" 
                          style={{ backgroundColor: skill.theme_color || '#3B82F6' }}
                        />
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <form action={deleteSkill}>
                          ...
                          <DeleteButton confirmMessage="Are you sure you want to delete this skill path?" />
                        </form>
                      </div>
                    </td>
                  </tr>
